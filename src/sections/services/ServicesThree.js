            ...
            <Row>
              <Col md={4}>
                <AnimationContainer animation='fadeInLeft' delay={200}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/mobile.png' alt='about' />
                    </ServiceIcon>
                    <ServiceHeading>Mobile Responsive</ServiceHeading>
                    <ServiceSeparator />
                    <ServiceList>
                      <ServiceListElement>
                        Mobile web design is a critical element for businesses
                        building a new website. We help you developing mobile
              ...
              <Col md={4}>
                <AnimationContainer animation='fadeInDown' delay={400}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/web.png' alt='about' />
                    </ServiceIcon>
                    <ServiceHeading>Web Development</ServiceHeading>
                    <ServiceSeparator />
                    <ServiceList>
                      <ServiceListElement>
                        We enjoy creating beautifully designed, intuitive and
                        functional websites. We also design UI, based on your
                        how you want the website to look like. You're the boss
                        here!
                      </ServiceListElement>
                    </ServiceList>
                  </ServiceElement>
              ...
              <Col md={4}>
                <AnimationContainer animation='fadeInRight' delay={600}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/email.png' alt='about' />
                    </ServiceIcon>
                    <ServiceHeading>WordPress Development</ServiceHeading>
                    <ServiceSeparator />
                    <ServiceList>
                      <ServiceListElement>
                        Offers all possible WordPress services ranging from
                        custom wordpress theme development, plugin
                        customization, wordpress speed optimization, SEO, and
              ...
              <Col md={4}>
                <AnimationContainer animation='fadeInLeft' delay={800}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/seo2.png' alt='about' />
                    </ServiceIcon>
                    <ServiceHeading>Search Engine Optimization</ServiceHeading>
                    <ServiceSeparator />
                    <ServiceList>
                      <ServiceListElement>
                        SEO is so important. In short, SEO is significant
                        because it makes your website more visible, and that
                        means more traffic and more opportunities to convert
              ...
              <Col md={4}>
                <AnimationContainer animation='fadeInUp' delay={1000}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/network.png' alt='about' />
                    </ServiceIcon>
                    <ServiceHeading>Security</ServiceHeading>
                    <ServiceSeparator />
                    <ServiceList>
                      <ServiceListElement>
                        A secure connection gives your customers peace of mind
                        that your website can be trusted and their information
                        is safe. We provide you absolute security with day to
                        day updates and backups.
                      </ServiceListElement>
                    </ServiceList>
                  </ServiceElement>
                </AnimationContainer>
              ...
              <Col md={4}>
                <AnimationContainer animation='fadeInRight' delay={1200}>
                  <ServiceElement>
                    <ServiceIcon>
                      <img src='/img/sketch.png' alt='about' />
                    </ServiceIcon>
