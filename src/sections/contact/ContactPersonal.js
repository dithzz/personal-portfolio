          ...
          <AnimationContainer animation='fadeIn'>
            <FormRow>
              ...
              <ContactCol md={6}>
                <Map
                  title='map'
                  src='https://www.google.com/maps/d/embed?mid=1qJTcq5CaMdI4s4mNWp9Mi7QpJHQ&hl=en'
                />
              </ContactCol>
            </FormRow>
          </AnimationContainer>
          <IconRow>
            <IconCol md={4}>
              <AnimationContainer animation='fadeIn' delay={500}>
                <InfoPart>
                  <IconContainer>
                    <Icon src='/img/email2.png' alt='email' />
                  </IconContainer>
                  <Info>
                    <InfoTitle>Email</InfoTitle>
                    <InfoLinkContainer>
                      <InfoLink href='mailto:adithditha20@gmail.com'>
                        adithditha20@gmail.com
                      </InfoLink>
                    </InfoLinkContainer>
                  </Info>
                </InfoPart>
            ...
            <IconCol md={4}>
              <AnimationContainer animation='fadeIn' delay={1000}>
                <InfoPart>
                  <IconContainer>
                    <Icon src='/img/phone.png' alt='phone' />
                  </IconContainer>
                  <Info>
            ...
            <IconCol md={4}>
              <AnimationContainer animation='fadeIn' delay={1500}>
                <InfoPart>
                  <IconContainer>
                    <Icon src='/img/map.png' alt='map' />
                  </IconContainer>
                  <Info>
                    <InfoTitle>Address</InfoTitle>
                    <InfoLinkContainer>
                      <InfoLink>Chennai, Tamil-Nadu</InfoLink>
                    </InfoLinkContainer>
                  </Info>
                </InfoPart>
              </AnimationContainer>
